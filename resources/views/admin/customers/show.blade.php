    ...
    <div class="bg-white/10 backdrop-blur-xl border border-white/20
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="flex justify-center">
                <div class="w-64 h-64 rounded-3xl overflow-hidden shadow-xl
            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        ...
                        <span class="text-white font-medium">{{ $customer->contact_person ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70">Phone 1</span>
                        <span class="text-white font-medium">{{ $customer->phone1 }}</span>
                    </div>

                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70">Phone 2</span>
                        <span class="text-white font-medium">{{ $customer->phone2 ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70">Email</span>
                        <span class="text-white font-medium">{{ $customer->email ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70">City</span>
                        <span class="text-white font-medium capitalize">{{ $customer->city?->name ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70">Industry</span>
                        <span class="text-white font-medium">{{ $customer->industry?->name ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70">Address</span>
                        <span class="text-white font-medium">{{ $customer->address ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70">Added On</span>
                        <span class="text-white font-medium">{{ $customer->created_at->format('d M, Y') }}</span>
                    </div>
