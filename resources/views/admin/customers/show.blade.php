            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex justify-between items-center bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70 flex items-center gap-2"><i data-lucide="user" class="w-4 h-4"></i> Contact Person</span>
                        <span class="text-white">{{ $customer->contact_person ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between items-center bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70 flex items-center gap-2"><i data-lucide="phone" class="w-4 h-4"></i> Phone 1</span>
                        <span class="text-white">{{ $customer->phone1 }}</span>
                    </div>

                    <div class="flex justify-between items-center bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70 flex items-center gap-2"><i data-lucide="phone" class="w-4 h-4"></i> Phone 2</span>
                        <span class="text-white">{{ $customer->phone2 ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between items-center bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70 flex items-center gap-2"><i data-lucide="mail" class="w-4 h-4"></i> Email</span>
                        <span class="text-white">{{ $customer->email ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between items-center bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70 flex items-center gap-2"><i data-lucide="map-pin" class="w-4 h-4"></i> City</span>
                        <span class="text-white capitalize">{{ $customer->city?->name ?? 'N/A' }}</span>
                    </div>

                    <div class="flex justify-between items-center bg-white/10 py-3 px-4 rounded-xl">
                        <span class="text-white/70 flex items-center gap-2"><i data-lucide="factory" class="w-4 h-4"></i> Industry</span>
...
<div id="imagePreviewModal"
    ...
    <div class="relative w-full max-w-4xl mx-auto bg-white/10 border border-white/20 backdrop-blur-2xl
        ...
        <img id="previewImage" src=""
             class="w-full max-h-[80vh] object-contain rounded-2xl shadow-xl">
    </div>
</div>
