...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-2xl shadow-lg">
        <h3 class="text-sm font-medium text-white/80">Total Salesmen</h3>
    ...
    <!-- Customers -->
    <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-2xl shadow-lg">
        <h3 class="text-sm font-medium text-white/80">Total Customers</h3>
        <p class="text-4xl font-extrabold text-white mt-2">
    ...
    <!-- Visits -->
    <div class="bg-white/10 backdrop-blur-xl border border-white/20 p-6 rounded-2xl shadow-lg">
        <h3 class="text-sm font-medium text-white/80">This Month Visits</h3>
        <p class="text-4xl font-extrabold text-white mt-2">
