            ...
            <table class="w-full text-left text-white/90">
                <thead class="bg-white/10 border-b border-white/20">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-sm font-semibold text-white/80">Address</th>
                        <th class="px-4 py-3 text-sm font-semibold text-white/80">Action</th>
                    </tr>
                </thead>
                        ...
                        <tr class="border-b border-white/10 hover:bg-white/10 transition">
                            ...
                            <td class="px-4 py-3">
                                <a href="{{ route('salesman.customers.show', $customer->id) }}"
                                    class="btn btn-primary btn-sm text-indigo-300 hover:text-indigo-400 underline">
                                    View
                                </a>
                            </td>
