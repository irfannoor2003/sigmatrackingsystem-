...
<div class=" p-0 md:p-6">
    ...
    <h1 class="text-3xl font-bold text-white mb-6 tracking-wide flex items-center">
        {{-- Lucide Icon: user-2 --}}
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-2 mr-3">
    ...
    <div class="mb-6 flex justify-between">
        <a href="{{ route('salesman.customers.create') }}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-plus mr-1">
                <path d="M5 12h14"/>
                <path d="M12 5v14"/>
            </svg>
            Add Customer
            ...
            @forelse ($customers as $customer)
                ...
                <div class="bg-white/10 border border-white/10 rounded-xl p-4 shadow-lg mb-3">
                    ...
                    <h2 class="text-lg font-semibold text-white mb-2 flex items-center">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-building mr-2 text-pink-400">
                    ...
                    <p class="text-white/70 text-sm mb-2 flex items-center">
                        {{-- Lucide Icon: contact --}}
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-user-round mr-2 text-white/50">
                    ...
                    <p class="text-white/80 text-sm mb-2 flex items-center">
                        {{-- Lucide Icon: phone --}}
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-phone mr-2 text-white/50">
                    ...
                    <p class="text-white/70 text-sm mb-3 flex items-start">
                        {{-- Lucide Icon: map-pin --}}
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pin mr-2 text-white/50 flex-shrink-0 mt-0.5">
